...
**Operations Intelligence Analyzer** is a production-focused OEE analysis suite for manufacturing operations. It ingests MES exports (including structured OEE exports), classifies downtime causes, computes production-weighted KPIs, and emits Excel/PDF/web outputs.
